...
// Test_MFC.cpp : 응용 프로그램에 대한 클래스 동작을 정의합니다.
//
...
CTest_MFCApp::CTest_MFCApp()
{
	...
	SetAppID(_T("Test_MFC.AppID.NoVersion"));

	// TODO: 여기에 생성 코드를 추가합니다.
	// InitInstance에 모든 중요한 초기화 작업을 배치합니다.
}

// 유일한 CTest_MFCApp 개체입니다.
...
// CTest_MFCApp 사용자 지정 로드/저장 메서드

void CTest_MFCApp::PreLoadState()
{
	BOOL bNameValid;
	CString strName;
...
void CTest_MFCApp::LoadCustomState()
{
}

void CTest_MFCApp::SaveCustomState()
{
}
